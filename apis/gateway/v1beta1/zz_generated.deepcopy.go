...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TransformPair) DeepCopyInto(out *TransformPair) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TransformPair.
func (in *TransformPair) DeepCopy() *TransformPair {
	if in == nil {
		return nil
	}
	out := new(TransformPair)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Transforms) DeepCopyInto(out *Transforms) {
	*out = *in
	if in.HostHeaderRewrites != nil {
		in, out := &in.HostHeaderRewrites, &out.HostHeaderRewrites
		*out = new([]TransformPair)
		if **in != nil {
			in, out := *in, *out
			*out = make([]TransformPair, len(*in))
			copy(*out, *in)
		}
	}
	if in.PathRewrites != nil {
		in, out := &in.PathRewrites, &out.PathRewrites
		*out = new([]TransformPair)
		if **in != nil {
			in, out := *in, *out
			*out = make([]TransformPair, len(*in))
