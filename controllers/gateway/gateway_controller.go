...
func (r *gatewayReconciler) setupCommonGatewayControllerWatches(ctrl controller.Controller, mgr ctrl.Manager) error {
	...
	// Add XListenerSet watching to trigger Gateway reconciliation
	xListenerSetEventHandler := eventhandlers.NewEnqueueRequestsForXListenerSetEventHandler(r.k8sClient, r.eventRecorder, r.controllerName,
		loggerPrefix.WithName("XListenerSet"))
	ctrl.Watch(source.Kind(mgr.GetCache(), &gwxalpha1.XListenerSet{}, xListenerSetEventHandler))
