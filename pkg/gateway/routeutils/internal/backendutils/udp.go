...
var _ routeutils.RouteRule = &convertedUDPRouteRule{}

var defaultUDPRuleAccumulator = routeutils.newAttachedRuleAccumulator[gwalpha2.UDPRouteRule](routeutils.commonBackendLoader, routeutils.listenerRuleConfigLoader)
...
func convertUDPRouteRule(rule *gwalpha2.UDPRouteRule, backends []Backend) routeutils.RouteRule {
...
type udpRouteDescription struct {
	...
	ruleAccumulator           routeutils.attachedRuleAccumulator[gwalpha2.UDPRouteRule]
	compatibleHostnamesByPort map[int32][]gwv1.Hostname
}

func (udpRoute *udpRouteDescription) GetAttachedRules() []routeutils.RouteRule {
...
func (udpRoute *udpRouteDescription) loadAttachedRules(ctx context.Context, k8sClient client.Client, gatewayDefaultTGConfig *elbv2gw.TargetGroupConfiguration) (RouteDescriptor, []routeLoadError) {
	...
	}, func(urr *gwalpha2.UDPRouteRule, backends []Backend, listenerRuleConfiguration *elbv2gw.ListenerRuleConfiguration) routeutils.RouteRule {
