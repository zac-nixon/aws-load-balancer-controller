...
var _ routeutils.RouteRule = &convertedTCPRouteRule{}

var defaultTCPRuleAccumulator = routeutils.newAttachedRuleAccumulator[gwalpha2.TCPRouteRule](routeutils.commonBackendLoader, routeutils.listenerRuleConfigLoader)
...
func convertTCPRouteRule(rule *gwalpha2.TCPRouteRule, backends []Backend) routeutils.RouteRule {
...
type tcpRouteDescription struct {
	...
	ruleAccumulator           routeutils.attachedRuleAccumulator[gwalpha2.TCPRouteRule]
	compatibleHostnamesByPort map[int32][]gwv1.Hostname
}

func (tcpRoute *tcpRouteDescription) GetAttachedRules() []routeutils.RouteRule {
...
func (tcpRoute *tcpRouteDescription) loadAttachedRules(ctx context.Context, k8sClient client.Client, gatewayDefaultTGConfig *elbv2gw.TargetGroupConfiguration) (RouteDescriptor, []routeLoadError) {
	...
	}, func(trr *gwalpha2.TCPRouteRule, backends []Backend, listenerRuleConfiguration *elbv2gw.ListenerRuleConfiguration) routeutils.RouteRule {
