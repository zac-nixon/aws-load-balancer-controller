...
var _ routeutils.RouteRule = &convertedGRPCRouteRule{}

var defaultGRPCRuleAccumulator = routeutils.newAttachedRuleAccumulator[gwv1.GRPCRouteRule](routeutils.commonBackendLoader, routeutils.listenerRuleConfigLoader)
...
func convertGRPCRouteRule(rule *gwv1.GRPCRouteRule, backends []Backend, listenerRuleConfig *elbv2gw.ListenerRuleConfiguration) routeutils.RouteRule {
...
type grpcRouteDescription struct {
	...
	ruleAccumulator           routeutils.attachedRuleAccumulator[gwv1.GRPCRouteRule]
...
func (grpcRoute *grpcRouteDescription) loadAttachedRules(ctx context.Context, k8sClient client.Client, gatewayDefaultTGConfig *elbv2gw.TargetGroupConfiguration) (RouteDescriptor, []routeLoadError) {
	convertedRules, allErrors := grpcRoute.ruleAccumulator.accumulateRules(ctx, k8sClient, grpcRoute, grpcRoute.route.Spec.Rules,
		func(rule gwv1.GRPCRouteRule) []gwv1.BackendRef {
			...
			return routeutils.getListenerRuleConfigForRuleGeneric(rule.Filters, func(filter gwv1.GRPCRouteFilter) bool {
		...
		}, func(grr *gwv1.GRPCRouteRule, backends []Backend, listenerRuleConfiguration *elbv2gw.ListenerRuleConfiguration) routeutils.RouteRule {
...
func (grpcRoute *grpcRouteDescription) GetAttachedRules() []routeutils.RouteRule {
...
func (grpcRoute *grpcRouteDescription) GetRouteListenerRuleConfigRefs() []gwv1.LocalObjectReference {
	...
	if grpcRoute.route.Spec.Rules != nil {
		for _, rule := range grpcRoute.route.Spec.Rules {
			cfgList := routeutils.getListenerRuleConfigForRuleGeneric(rule.Filters,
