...
var _ routeutils.RouteRule = &convertedHTTPRouteRule{}

var defaultHTTPRuleAccumulator = routeutils.newAttachedRuleAccumulator[gwv1.HTTPRouteRule](routeutils.commonBackendLoader, routeutils.listenerRuleConfigLoader)
...
func convertHTTPRouteRule(rule *gwv1.HTTPRouteRule, backends []Backend, listenerRuleConfig *elbv2gw.ListenerRuleConfiguration) routeutils.RouteRule {
...
type httpRouteDescription struct {
	...
	ruleAccumulator           routeutils.attachedRuleAccumulator[gwv1.HTTPRouteRule]
	compatibleHostnamesByPort map[int32][]gwv1.Hostname
}

func (httpRoute *httpRouteDescription) GetAttachedRules() []routeutils.RouteRule {
...
func (httpRoute *httpRouteDescription) loadAttachedRules(ctx context.Context, k8sClient client.Client, gatewayDefaultTGConfig *elbv2gw.TargetGroupConfiguration) (RouteDescriptor, []routeLoadError) {
	convertedRules, allErrors := httpRoute.ruleAccumulator.accumulateRules(ctx, k8sClient, httpRoute, httpRoute.route.Spec.Rules,
		func(rule gwv1.HTTPRouteRule) []gwv1.BackendRef {
			...
			return routeutils.getListenerRuleConfigForRuleGeneric(rule.Filters,
		...
		}, func(hrr *gwv1.HTTPRouteRule, backends []Backend, listenerRuleConfiguration *elbv2gw.ListenerRuleConfiguration) routeutils.RouteRule {
