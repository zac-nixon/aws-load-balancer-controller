...
var _ routeutils.RouteRule = &convertedTLSRouteRule{}

var defaultTLSRuleAccumulator = routeutils.newAttachedRuleAccumulator[gwv1.TLSRouteRule](routeutils.commonBackendLoader, routeutils.listenerRuleConfigLoader)
...
func convertTLSRouteRule(rule *gwv1.TLSRouteRule, backends []Backend) routeutils.RouteRule {
...
type tlsRouteDescription struct {
	...
	ruleAccumulator           routeutils.attachedRuleAccumulator[gwv1.TLSRouteRule]
	compatibleHostnamesByPort map[int32][]gwv1.Hostname
}

func (tlsRoute *tlsRouteDescription) GetAttachedRules() []routeutils.RouteRule {
...
func (tlsRoute *tlsRouteDescription) loadAttachedRules(ctx context.Context, k8sClient client.Client, gatewayDefaultTGConfig *elbv2gw.TargetGroupConfiguration) (RouteDescriptor, []routeLoadError) {
	...
	}, func(trr *gwv1.TLSRouteRule, backends []Backend, listenerRuleConfiguration *elbv2gw.ListenerRuleConfiguration) routeutils.RouteRule {
