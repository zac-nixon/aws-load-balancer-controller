...
func Test_buildTargetGroupPort(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			svcBackend := &ServiceBackendConfig{
				ServicePort: &tc.svcPort,
			}
			res := svcBackend.GetDataPort(tc.targetType)
...
func Test_buildTargetGroupIPAddressType(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			res := svcBackend.GetIPAddressType()
			assert.Equal(t, tc.expected, res)
...
func Test_buildTargetGroupHealthCheckPort(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			svcBackend := &ServiceBackendConfig{
				Service:          tc.svc,
				TargetGroupProps: tc.targetGroupProps,
			}
